export const SearchIcon = ({ width = '2.6rem', height = '2.6rem' }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const UserIcon = ({ width = '2.6rem', height = '2.6rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const DownIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        stroke="currentColor"
        fill="currentColor"
...
export const TopIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const ClearIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const Next = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const Prev = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const ArrowRightIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const MessageIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
    >
        <path d="M775.3 248.9a369.62 369.62 0 0 0-119-80A370.2 370.2 0 0 0 512.1 140h-1.7c-99.7.4-193 39.4-262.8 109.9-69.9 70.5-108 164.1-107.6 263.8.3 60.3 15.3 120.2 43.5 173.1l4.5 8.4V836h140.8l8.4 4.5c52.9 28.2 112.8 43.2 173.1 43.5h1.7c99 0 192-38.2 262.1-107.6 70.4-69.8 109.5-163.1 110.1-262.7.2-50.6-9.5-99.6-28.9-145.8a370.15 370.15 0 0 0-80-119zM312 560a48.01 48.01 0 0 1 0-96 48.01 48.01 0 0 1 0 96zm200 0a48.01 48.01 0 0 1 0-96 48.01 48.01 0 0 1 0 96zm200 0a48.01 48.01 0 0 1 0-96 48.01 48.01 0 0 1 0 96z"></path>
...
export const ViewIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const Facebook = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const Instagram = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const Twitter = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const Youtube = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const Google = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const StarIcon = ({ width = '2rem', height = '2rem', className, ...props }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const FullFillStarIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
